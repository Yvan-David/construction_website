...
<p className='text-[10px] tablet:text-xs text-gray-400 text-start hover:text-gray-200 transition-all '><Link to={"constructionmaterials@gmail.com"}>constructionmaterials@gmail.com</Link></p>
    ...
    <p className='text-xs text-gray-400'>&copy; {year} All rights reserved - BuildSource Team</p>
